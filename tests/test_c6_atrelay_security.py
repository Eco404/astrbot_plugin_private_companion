...
class _Harness:
    def __init__(self, *, owner=True, whitelist=None, blacklist=None, data=None, current_group=""):
        self._owner = owner
...
class AtRelaySecurityTests(unittest.TestCase):
    ...
    def test_blacklist_takes_precedence_over_whitelist(self):
        ...
        harness._atrelay_known_group_ids = self._bind(harness, "_atrelay_known_group_ids")
