...
- AstrBot 版本：`>=4.22.0`
- 编码要求：UTF-8
- 维护状态：5.9.2 重点优化日记体验：日记改为有场景、有变化、有余韵的私密记录，主动素材与内部计划不再干扰阅读。
...
- 相关设置：主动图片分享、生图后端、在线生图模型平台、文生图工作流、自拍工作流、参考图一致性（可选）、人设参考图路径（可选）、每日穿搭照片、自然语言生图/改图、自然语言生图附加提示词、生图场景预设、本地图片读取保护。
