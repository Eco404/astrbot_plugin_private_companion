...
class CommandHandlersMixin:
    ...
    def _companion_manual_config_display_meta(self) -> dict[str, dict[str, str]]:
        return {
            ...
            "qzone_life_publish_double_windows": {"label": "生活说说双窗口时段", "location": "拓展页 -> 功能开关 -> 长线主动 -> QQ 空间联动详情 -> 生活说说"},
            "qzone_life_publish_custom_windows": {"label": "生活说说自定义窗口", "location": "拓展页 -> 功能开关 -> 长线主动 -> QQ 空间联动详情 -> 生活说说"},
